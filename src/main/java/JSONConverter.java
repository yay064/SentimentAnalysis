...
public class JSONConverter {
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("/Users/ericyang/Downloads/SentimentOutput/part-r-00000"));
        String line = br.readLine();
        FileWriter fileWriter = new FileWriter("/Users/ericyang/Downloads/SentimentOutput/result.json");
